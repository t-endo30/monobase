...
<div class="container">
  <div class="static-wrap">
    <h2>このサイトの立ち位置</h2>
    <p>モノベースは、購入者レビューとメーカー公式仕様を突き合わせて、<mark>良い点だけでなく「向かない人」まで書く</mark>ことを方針にした商品紹介サイトです。売れている順に並べるのではなく、どんな条件のときに困るのかを先に示します。</p>
    <p>記事は、公式が公開している仕様（型番・寸法・消費電力など）と、販売サイトの購入者レビューから読み取れる傾向を、別のものとして扱います。裏の取れていない数値は載せません。</p>
