...
<g stroke="var(--mk-line,#9a9a9a)" stroke-width="0.9" stroke-linejoin="round">
  <path d="M32 14 L10 26 L3 17 L30 4 Z" fill="var(--mk-flap,#f2f2f2)"/>
  <path d="M32 14 L54 26 L61 17 L34 4 Z" fill="var(--mk-flap,#f2f2f2)"/>
...
<g fill="var(--mk-letter,#ffffff)" font-family="Helvetica Neue,Helvetica,Arial,sans-serif"
  ...
  <text x="21" y="29.4" transform="matrix(1,0.6,0,1,0,0)">M</text>
  <text x="43" y="67.8" transform="matrix(1,-0.6,0,1,0,0)">B</text>
</g>
</svg>'''
